...
WorkspacePath          :=C:/Users/rogert.aaxeon/OneDrive/School/CSCI123/Blackjack-Fresh
ProjectPath            :=C:/Users/rogert.aaxeon/OneDrive/School/CSCI123/Blackjack-Fresh/04-ASCI-V2
...
$(IntermediateDirectory)/Card.cpp$(ObjectSuffix): Card.cpp $(IntermediateDirectory)/Card.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/rogert.aaxeon/OneDrive/School/CSCI123/Blackjack-Fresh/04-ASCI-V2/Card.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Card.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Deck.cpp$(ObjectSuffix): Deck.cpp $(IntermediateDirectory)/Deck.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/rogert.aaxeon/OneDrive/School/CSCI123/Blackjack-Fresh/04-ASCI-V2/Deck.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Deck.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Blackjack.cpp$(ObjectSuffix): Blackjack.cpp $(IntermediateDirectory)/Blackjack.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/rogert.aaxeon/OneDrive/School/CSCI123/Blackjack-Fresh/04-ASCI-V2/Blackjack.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Blackjack.cpp$(ObjectSuffix) $(IncludePath)
